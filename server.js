...
function removeEmployees() {
  ...
  // Once the employee list is chosen employee is deleted
...
// once the prompt is finished new item is added into database
      ...
      .then(function (answer) {
        ...
        connection.query(query, {
          ...
          function (err, res) {
            ...
            console.table(res);
            console.log("Your role has been inserted!");
